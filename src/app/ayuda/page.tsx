...
export default function Page() {
  ...
  return (
    <div className={style.ayuda_page}>
      <Contact />
      <Accordion>
        <AccordionItem key="1" aria-label="¿Qué servicios encuentro en MAS EU?" title="1. ¿Qué servicios encuentro en MAS EU?">
        ...
        <AccordionItem key="2" aria-label="" title="2. ¿Es necesario disponer de alguna herramienta para llevar a cabo el servicio?">
        ...
        <AccordionItem key="3" aria-label="Accordion 3" title="3. ¿Cuál es el área de cobertura de sus servicios?">
        ...
        <AccordionItem key="4" aria-label="Accordion 3" title="4. ¿Cuáles son las opciones de pago disponibles?">
          {"Nuestra área de cobertura se extiende a Bucaramanga y su área metropolitana."}
        </AccordionItem>
        <AccordionItem key="5" aria-label="Accordion 3" title="5.¿Cómo me registro en la página?">
        ...
        <AccordionItem key="6" aria-label="Accordion 3" title="6. ¿Cómo puedo saber el estado de mi servicio?">
        ...
        <AccordionItem key="7" aria-label="Accordion 3" title="3. ¿Cuáles son las opciones de pago disponibles?">
          {defaultContent}
        </AccordionItem>
